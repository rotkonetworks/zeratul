# standardized benchmark for ligerito.jl - 2^28
using BinaryFields, Ligerito, Random

println("=== ligerito.jl standardized benchmark (2^28) ===")
...
# warmup runs to trigger JIT compilation (3 iterations for large size)
println("warming up...")
for _ in 1:3
