# standardized benchmark for ligerito.jl - 2^20
using BinaryFields, Ligerito, Random

println("=== ligerito.jl standardized benchmark (2^20) ===")
...
# warmup runs to trigger JIT compilation (5 iterations for stable JIT)
println("warming up...")
for _ in 1:5
