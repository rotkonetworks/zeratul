...
export type ServerMsg =
  ...
  | { type: 'RulesAccepted' }
  | { type: 'RoomInfo'; code: string; jury_nodes: number; jury_threshold: number; escrow: string; staked?: boolean; frost_relay_url?: string; frost_room_code?: string; seat_addresses?: (string | null)[]; required_deposit: number; buyin_zat?: number; fee_per_seat?: number }
